...
elements = soup.select('.condition.J_stardandDepartmentId')

sections = elements[2].select('.J_Submit_A')

sql = "INSERT INTO sections (`key`, `name`) VALUES (%s, %s)"
for section in sections:
    key = section.attrs['data-val']
