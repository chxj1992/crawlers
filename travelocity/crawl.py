        ...
        for sailingYear in res['sailingYears']:
            for sailingMonth in sailingYear['sailingMonths']:
                for sailingDate in sailingMonth['sailingDates']:
                    ...
                    data.append("('" + str(cruiseCard['itineraryId']) + "', '" + title + "', '" + cruiseCard['shipName'] + \
                            "', '" + str(cruiseCard['duration']) + "', '" + cruiseCard['startPort'] + \
                            "', FROM_UNIXTIME(" + str(departureTime) + \
                            "), '" + str(sailingDate['insideCabinPrice']) + "', '" + str(sailingDate['oceanViewCabinPrice']) + \
                            "', '" + str(sailingDate['balconyCabinPrice']) + "', '" + str(sailingDate['suiteCabinPrice']) + \
